...
30.times do
  city = City.create!(name: Faker::Name.first_name)
end
...
30.times do
  patient = Patient.create!(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name,  postal_code: Faker::Number.between(1, 25), city_id: Faker::Number.between(1, 25))
end
